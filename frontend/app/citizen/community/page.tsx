...
export default function PlaceholderPage() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50 text-charcoal">
            <span className="material-symbols-outlined text-6xl text-primary mb-4">diversity_3</span>
            <h1 className="text-2xl font-bold">Community Hub</h1>
            <p className="text-slate-500 mb-8">Connect with neighbors and organize clean-up drives.</p>
